<template>
  ...
  >
    <path
      ...
      stroke="white"
    />
    <path d="M7 7L11 7" stroke="white" stroke-linecap="round" />
    <path d="M8 11H7" stroke="white" stroke-linecap="round" />
    <path d="M7 15L10 15" stroke="white" stroke-linecap="round" />
  </svg>
</template>
